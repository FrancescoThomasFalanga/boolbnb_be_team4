...
<main id="apartment_create">
    ...
    <div class="container">
        ...
        <h1 class="my-4">Aggiungi un nuovo appartamento</h1>
        ...
        <form autocomplete="off" action="{{route ('admin.apartments.store')}}" method="POST" enctype="multipart/form-data" onsubmit="return validateServices()" id="create-form">
            ...
            <div class="mb-4">
                ...
                <select name="isVisible" id="isVisible" class="w-20" required>
                    <option value=1 {{ old('isVisible') == '1' ? 'selected' : '' }}>Mostra in Lista</option>
                    <option value=0 {{ old('isVisible') == '0' ? 'selected' : '' }}>Nascosto in Lista</option>
                </select>
            </div>
           ...
           <div class="mb-3 _address-wrapper">
            ...
            {{-- sqm --}}
            <div class="mb-3">
                <label for="sqm" class="mb-2">Area (mq) *</label>
            ...
            {{-- submit --}}
            <button type="submit" class="btn btn-primary my-2" >Aggiungi Appartamento</button>
        </form>
